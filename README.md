...
Ads operations platform: marketing site (`/`, `/privacy`, `/terms`) plus an ops console. `/ops` is the hub; Campaigns / Listings / Metrics / Import / Reports / Connect live at `/ops/campaigns`, `/ops/listings`, `/ops/metrics`, `/ops/import`, `/ops/reports`, and `/ops/connect`.
...
Open [http://localhost:3000](http://localhost:3000) (marketing) and [http://localhost:3000/ops](http://localhost:3000/ops) (hub). Shell routes: `/ops/campaigns`, `/ops/listings`, `/ops/metrics`, `/ops/import`, `/ops/reports`, `/ops/connect`.
