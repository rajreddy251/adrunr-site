...
async function main() {
  ...
  await prisma.clientMemory.upsert({
    ...
    create: {
      clientId: client.id,
      key: "ops_tone",
      value: "Prefers PAUSED Search, Display, Performance Max, and Demand Gen drafts. Dry-run before apply. Chat never validates or enables. Remarketing is a Display audience. PMax uses asset groups and search-theme signals. Demand Gen uses ad groups, multi-asset ads, and USER_LIST audiences.",
      source: "seed",
    },
    update: {},
  });
