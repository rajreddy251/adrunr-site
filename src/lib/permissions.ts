...
export const ALL_RESOURCES: PermissionResource[] = [
  ...
  "DEMAND_GEN_CAMPAIGN_DRAFT",
  "VIDEO_CAMPAIGN_DRAFT",
  "SHOPPING_CAMPAIGN_DRAFT",
  "APP_CAMPAIGN_DRAFT",
  "HOTEL_CAMPAIGN_DRAFT",
  "LOCAL_CAMPAIGN_DRAFT",
  "LOCAL_SERVICES_CAMPAIGN_DRAFT",
  "SYNCED_CAMPAIGN",
  "SYNC_JOB",
  "AUDIT_EVENT",
  "BILLING",
...
> = {
  ...
  AGENCY_MANAGER: [
    ...
    ...expand(["EXTERNAL_ACCOUNT", "EXTERNAL_ENTITY", "SYNCED_CAMPAIGN"], ["READ", "UPDATE", "LIST", "SYNC"]),
    ...expand(["CAMPAIGN_OP"], ["CREATE", "READ", "LIST", "DRY_RUN", "APPLY_PAUSED"]),
    ...expand(
      ["SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT"],
  ...
  AGENT: [
    ...expand(
      ["CLIENT", "WORKSPACE", "EXTERNAL_ACCOUNT", "EXTERNAL_ENTITY", "SYNCED_CAMPAIGN", "AUDIT_EVENT", "SYNC_JOB"],
      READ_LIST,
    ),
  ...
  FINANCE: [
    ...
    ...expand(
      ["ORGANIZATION", "CLIENT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT", "SYNCED_CAMPAIGN", "AUDIT_EVENT", "EXTERNAL_ACCOUNT"],
      READ_LIST,
    ),
  ],
};
...
> = {
  CLIENT_ADMIN: expand(
    ["EXTERNAL_ACCOUNT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT", "SYNCED_CAMPAIGN", "AUDIT_EVENT"],
    READ_LIST,
  ),
  CLIENT_USER: expand(
    ["EXTERNAL_ACCOUNT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT", "SYNCED_CAMPAIGN"],
    READ_LIST,
  ),
