...
> = {
  ...
  AGENCY_MANAGER: [
    ...
    ...expand(["EXTERNAL_ACCOUNT", "EXTERNAL_ENTITY", "SYNCED_CAMPAIGN", "CAMPAIGN_METRIC_SNAPSHOT"], ["READ", "UPDATE", "LIST", "SYNC"]),
  ...
  AGENT: [
    ...expand(
      ["CLIENT", "WORKSPACE", "EXTERNAL_ACCOUNT", "EXTERNAL_ENTITY", "SYNCED_CAMPAIGN", "CAMPAIGN_METRIC_SNAPSHOT", "CAMPAIGN_EDIT_DRAFT", "CAMPAIGN_IMPORT_JOB", "AUDIT_EVENT", "SYNC_JOB"],
      READ_LIST,
    ),
...
> = {
  CLIENT_ADMIN: expand(
    ["EXTERNAL_ACCOUNT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT", "SYNCED_CAMPAIGN", "CAMPAIGN_METRIC_SNAPSHOT", "CAMPAIGN_EDIT_DRAFT", "CAMPAIGN_IMPORT_JOB", "AUDIT_EVENT"],
    READ_LIST,
  ),
  CLIENT_USER: expand(
    ["EXTERNAL_ACCOUNT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT", "SYNCED_CAMPAIGN", "CAMPAIGN_METRIC_SNAPSHOT", "CAMPAIGN_EDIT_DRAFT", "CAMPAIGN_IMPORT_JOB"],
