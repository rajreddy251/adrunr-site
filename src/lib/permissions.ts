...
> = {
  ...
  AGENCY_MANAGER: [
    ...
    ...expand(
      ["SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "APP_CAMPAIGN_DRAFT", "HOTEL_CAMPAIGN_DRAFT", "LOCAL_CAMPAIGN_DRAFT", "LOCAL_SERVICES_CAMPAIGN_DRAFT", "CAMPAIGN_EDIT_DRAFT"],
  ...
  AGENT: [
    ...expand(
      ["CLIENT", "WORKSPACE", "EXTERNAL_ACCOUNT", "EXTERNAL_ENTITY", "SYNCED_CAMPAIGN", "CAMPAIGN_METRIC_SNAPSHOT", "CAMPAIGN_EDIT_DRAFT", "AUDIT_EVENT", "SYNC_JOB"],
      READ_LIST,
    ),
