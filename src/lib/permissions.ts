...
> = {
  ...
  AGENCY_MANAGER: [
    ...
    ...expand(
      ["SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT"],
  ...
  FINANCE: [
    ...
    ...expand(
      ["ORGANIZATION", "CLIENT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "AUDIT_EVENT", "EXTERNAL_ACCOUNT"],
      READ_LIST,
    ),
  ],
};
...
> = {
  CLIENT_ADMIN: expand(
    ["EXTERNAL_ACCOUNT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT", "AUDIT_EVENT"],
    READ_LIST,
  ),
  CLIENT_USER: expand(
    ["EXTERNAL_ACCOUNT", "CAMPAIGN_OP", "SEARCH_CAMPAIGN_DRAFT", "DISPLAY_CAMPAIGN_DRAFT", "PERFORMANCE_MAX_CAMPAIGN_DRAFT", "DEMAND_GEN_CAMPAIGN_DRAFT", "VIDEO_CAMPAIGN_DRAFT", "SHOPPING_CAMPAIGN_DRAFT"],
    READ_LIST,
  ),
