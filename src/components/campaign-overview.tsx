...
export function CampaignOverview() {
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6" data-testid="ops-campaign-overview">
      <CampaignFocusChrome campaignId={campaignId} campaign={campaign} snapshot={snapshot} mode="overview" />
